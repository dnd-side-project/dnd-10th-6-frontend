...
import a from '@/pages/assets/onboard/1.png'
import b from '@/pages/assets/onboard/2.png'
import c from '@/pages/assets/onboard/3.png'
import Image from 'next/image'
import WelcomeTrees from '../icons/welcome-trees'
...
import { Filter, FilterProvider } from '@/hooks/use-filter'
...
export const onBoardingItems = [
  ...
  <div
    key="step2"
    className="px-5 h-full flex flex-col items-center text-center space-y- justify-center"
  >
    <h2 className="text-[2.3vb]">
    ...
    <section className="p-[0.75vb] aspect-[1/2.1653] rounded-[3vb] shadow-onboard overflow-hidden flex flex-col w-[25vb]">
      <div className="flex flex-col overflow-y-scroll scrollbar-hide relative grow pb-[0.5vb]">
        ...
        <main>
          ...
          <div className={cn('sticky top-0 bg-white mb-3 duration-300 z-10')}>
